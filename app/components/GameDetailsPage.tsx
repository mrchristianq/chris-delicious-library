            ...
            <>
              ...
              {(igdbRating || myRating || hoursPlayed) ? (
                <>
                  ...
                  <div style={{ display: "flex", gap: 12, justifyContent: "space-evenly", alignItems: "center", flexWrap: "wrap" }}>
                    {igdbRating ? <ScoreCircle raw={igdbRating} label="IGDB Rating" labelColor={palette.mutedText} layout="inline" /> : null}
                    ...
                    {hoursPlayed ? (
                      <div style={{ display: "flex", flexDirection: "row", alignItems: "center", gap: 10, flexShrink: 0 }}>
                        ...
                        <div style={{ fontSize: 14, fontWeight: 700, color: palette.mutedText, textAlign: "left", lineHeight: 1.2 }}>
                          Hours
                        </div>
                      </div>
                    ) : null}
