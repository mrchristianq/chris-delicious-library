...
function rowToShow(r: Row): Show | null {
  ...
  return {
    ...
    dateCompleted: safeStr(r["Date Completed"]) || safeStr(r["Completd Date"]) || safeStr(r["CompletdDate"]) || safeStr(r["CompletedDate"]) || undefined,
...
function rowToBook(r: Row): Book | null {
  ...
  return {
    ...
    completedDate: safeStr(r["Date Completed"]) || safeStr(r["CompletedDate"]) || undefined,
