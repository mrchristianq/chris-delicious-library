...
const RELEASE_STATUS_OPTIONS = ["Released", "Upcoming", "In Production", "Canceled"] as const;
...
const MOVIE_FIELDS: FieldDef[] = [
  ...
  { key: "watchDate",   label: "Watch Date",      isDate: true },
...
export function MovieDetailsEditModal({ open, item, onClose, onSave }: MovieDetailsEditModalProps) {
  ...
  const handleSyncFromTMDB = async () => {
    ...
    try {
      ...
      // Build proposed values from TMDB, only overwriting non-empty incoming
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ marginLeft: 8, fontSize: 13, fontWeight: 650, color: "#1d2735" }}>Edit Movie</span>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: 6 }}>
                <button
                  type="button"
                  onClick={() => setSyncDiff((prev) => prev?.map((r) => ({ ...r, selected: true })) ?? null)}
                ...
                <button
                  type="button"
                  onClick={() => setSyncDiff((prev) => prev?.map((r) => ({ ...r, selected: false })) ?? null)}
